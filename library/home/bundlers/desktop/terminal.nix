...
in
{
  ...
  # warp-terminal theme synced with stylix.
  # warp reads from ~/.warp/themes/ and ~/.config/warp-terminal/themes/.
  ...
  home.sessionVariables.TERMINAL = lib.mkDefault prefs.terminal;
}
